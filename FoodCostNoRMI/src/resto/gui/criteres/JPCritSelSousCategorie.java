 ...
 * @author g38302
 */
public class JPCritSelSousCategorie extends JPCritSelGenerique<SousCategorieSel> {

    public JPCritSelSousCategorie() {
        initComponents();
    }

    @Override
    public void setSel(SousCategorieSel sel) {
        if (sel == null) {
            jTLibelle.setText("");
        } else {
    ...
    @Override
    public SousCategorieSel getCriteres() {
        SousCategorieSel e = new SousCategorieSel(0, jTLibelle.getText(), null);
        return e;
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Début de nom de la sous-catégorie : ");
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addComponent(jTLibelle, javax.swing.GroupLayout.DEFAULT_SIZE, 191, Short.MAX_VALUE)
                .addContainerGap())
        );
