 ...
 * @author Gilles
 */
public class ModifIngredient extends GenericDialog {
    ...
    public ModifIngredient(java.awt.Frame parent, boolean modal,FoodClientImpl modele, IngredientDto ingre, ListeAlimentDto list) {
        super(parent, modal,modele,"Modification de l'ingrédient : " + ingre.getId().getLibelle());
        initComponents();
        this.ingre = ingre;
